...
pub struct Skin {
    ...
    pub player: [(DynamicMaterial, Vec2); NUM_OF_GUN_MODELS as usize],
    pub invisible: DynamicMaterial,
    pub half_invisible: DynamicMaterial,
    pub enemy: (DynamicMaterial, Vec2),
